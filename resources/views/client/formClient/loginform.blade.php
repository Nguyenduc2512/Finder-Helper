...
@section('content')
    <div class="center-sign">
        ...
        <div class="card-body" style="width: 650px; background: white">
            <form action="{{route('login')}}" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input name="email" type="text" class="form-control form-control-lg" style="width: 400px"/>
                ...
                <span class="mt-3 mb-3 line-thru text-center">
                    <span>or</span>
                </span>
                ...
                <p class="text-center">@lang('messages.haveAccount')<a href="{{route('sign')}}">@lang('messages.signIn')</a></p>
