            ...
            <div data-spy="scoll" data-target=".navbar" data-offset="50" style="height: 890px; overflow-y: scroll; border-radius: 7px">
                @foreach($posts as $post)
                    <div class="job-post-item p-4 d-block d-md-flex align-items-center">
                        ...
                        <div class="ml-auto">
                            @if($post->apply == true)
                                <a href="{{route('user.post-detail', ['id' => $post->id])}}" class="btn btn-danger py-2 text-white" style="width: 120px">@lang('messages.cancel')</a>
                            @else
                                <a href="{{route('user.post-detail', ['id' => $post->id])}}" class="btn btn-warning py-2 text-white" style="width: 120px">@lang('messages.apply')</a>
                            @endif
                        </div>
                    </div>
                @endforeach
        ...
        <div data-spy="scoll" data-target=".navbar" data-offset="50" style="height: 890px; overflow-y: scroll; border-radius: 7px">
            @foreach($postsPriceHigh as $postPriceHigh)
                <div class="job-post-item p-4 d-block d-md-flex align-items-center">
                    ...
                    <div class="ml-auto">
                        @if($postPriceHigh->apply == true)
                            <a href="{{route('user.post-detail', ['id' => $postPriceHigh->id])}}" class="btn btn-danger py-2 text-white" style="width: 120px">@lang('messages.cancel')</a>
                        @else
                            <a href="{{route('user.post-detail', ['id' => $postPriceHigh->id])}}" class="btn btn-warning py-2 text-white" style="width: 120px">@lang('messages.apply')</a>
                        @endif
                    </div>
                </div>
            @endforeach
