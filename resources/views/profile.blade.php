@include('layout.layout-css')
@include('layout.layout-header')
@include('layout.search-slide')
<!-- content -->
<div class="container">
        ...
        <div id="profile" class="container tab-pane active"><br>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="col-1"><img src="{{asset('img/avatar-default-icon.png')}}" class="avatarProfile"><br></div>
                        <div class="row">
                            <div class="col-6"><img src="{{asset('img/avatar-default-icon.png')}}" alt="" class="card"></div>
                            <div class="col-6"><img src="{{asset('img/avatar-default-icon.png')}}" alt="" class="card"></div>
                        </div>
                    </div>
                </div>
